...
Five pages, in the order the questions tend to arrive.
...
Start with **what-this-is.md** if you haven't installed anything yet. Start with
**walkthrough.md** if you have and want to know what happens next.

The [README](../README.md) at the repository root is the short version of all of
it.
